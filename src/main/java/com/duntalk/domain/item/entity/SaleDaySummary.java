...
public class SaleDaySummary {
    ...
    private SaleDaySummary(Item item, LocalDateTime startTime, Long totalPrice, Long totalCount) {
        this.item = item;
    ...
    public static SaleDaySummary from(SaleSummaryDto dto, LocalDateTime startTime){
        return new SaleDaySummary(dto.getItem(), startTime, dto.getTotalPrice(), dto.getTotalCount());
    }
}
